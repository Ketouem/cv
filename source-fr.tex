...
% Compute age from birthdate (1987-10-10) using the build date
\newcount\age
\age=\year
\advance\age by -1987
\ifnum\month<10 \advance\age by -1 \fi
\ifnum\month=10 \ifnum\day<10 \advance\age by -1 \fi\fi
...
\extrainfo{\textcolor{black}{\the\age{} ans - Titulaire du permis B} \\ \\
           ...
           \href{https://goo.gl/HW9dKv}{\includegraphics[scale=0.50]{./images/codewars.png}}}
...
\AddToShipoutPictureBG*{%
  \AtPageUpperLeft{\color{blue!10}\rule[-5cm]{\paperwidth}{5cm}}%
}
...
% Dalma
\cventry{Depuis Novembre 2022}{Senior Solutions Architect}{Dalma}{Paris}{France}{%
}
% Viceversa
\cventry{Mars 2022 - Octobre 2022}{Senior Cloud Engineer / DevOps}{Viceversa (ex Barney)}{Paris}{France}{%
\begin{itemize}
