...
% D2SI
\cventry{Depuis Mai 2017}{Consultant Cloud}{D2SI}{Paris}{France}{%
\begin{itemize}
    \item Accompagnement et mise en place de chaîne CI/CD
    \item Déploiement d'environnement sur AWS
\end{itemize}
}
% WayzUp
