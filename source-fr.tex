...
\extrainfo{\textcolor{black}{29 ans - Titulaire du permis B} \\ \\
           \includegraphics[scale=0.50]{./images/linkedin.png} \url{https://goo.gl/0q4mqd}\\
           \includegraphics[scale=0.50]{./images/github.png} \url{https://goo.gl/HmYaEp}\\
           \includegraphics[scale=0.50]{./images/stackoverflow.png} \url{https://goo.gl/5I6niN}\\
           \includegraphics[scale=0.50]{./images/codewars.png}
           \url{https://goo.gl/HW9dKv}\tikzmark{end}}
...
% Enovacom
\cventry{Depuis Juillet 2017}{Senior Software Engineer}{Enovacom}{Boulogne-Billancourt}{France}{%
\begin{itemize}
    \item Création d'un pipeline \textbf{CircleCI} permettant la génération automatique d'une documentation utilisateur et leur publication sur un site dédié hébergé via \textbf{AWS S3}
    \item Maintien et amélioration de playbooks \textbf{Ansible} permettant le provisioning et la configuration applicative pour des machines virtuelles \textbf{EC2} / \textbf{VMWare-ESX}
    \item Mise en place de configurations \textbf{Terraform} pour AWS
\end{itemize}
}
% WayzUp
...
\cvitem{AWS}{Cloudfront, S3, EC2, Route53}
...
\cvitem{Configuration}{Ansible, Terraform}
\end{minipage}
% Skills -
\begin{minipage}[t]{0.5\textwidth}
